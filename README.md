...
- 📖 **[AI Writer System](https://github.com/entangelk/ai_writte_system)** — *flagship personal project*  
  ...
  `Process:` 96 decision briefs written *before* implementation · 269 independent verification records over 61 dated days · a suite of 2,316 passing tests (2,654 subtests) · two-way regression guards checked by mutation · a versioned canonical contract (`v1.8.14`, full change history retained). The verdict split is **185 pass · 80 conditional · 4 outright fail** — **30% do not come back clean**, which is what tells you the review is not a formality.  

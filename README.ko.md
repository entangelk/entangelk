...
- 📖 **[AI Writer System](https://github.com/entangelk/ai_writte_system)** — *대표 개인 프로젝트*  
  ...
  `Process:` 구현보다 **먼저** 쓴 결정 브리프 96개 · 61일치로 쌓인 독립 검증 기록 269건 · 통과 테스트 2,316건(서브테스트 2,654) · 뮤테이션으로 확인하는 양방향 회귀 가드 · 버전 관리되는 정본 계약(`v1.8.14`, 변경이력 전량 보존). 판정 분포는 **합격 185 · 조건부 합격 80 · 불합격 4** — **10건 중 3건은 깨끗하게 돌아오지 않습니다**. 검증이 형식적 통과가 아니라는 증거입니다.  
